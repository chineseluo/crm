...
public class CstCustomerDTO extends BaseDTO {
	...
	private Set<CstLinkmanDTO> cstLinkmanDTOs;
	private Set<CstLostDTO> cstLostDTOs;
	public Set<CstLostDTO> getCstLostDTOs() {
		return cstLostDTOs;
	}
	public void setCstLostDTOs(Set<CstLostDTO> cstLostDTOs) {
		this.cstLostDTOs = cstLostDTOs;
	}
	public Set<CstLinkmanDTO> getCstLinkmanDTOs() {
		return cstLinkmanDTOs;
	}
	public void setCstLinkmanDTOs(Set<CstLinkmanDTO> cstLinkmans) {
		this.cstLinkmanDTOs = cstLinkmans;
	}
