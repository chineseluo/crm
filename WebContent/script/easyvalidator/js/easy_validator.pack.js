	...
	$("[reg],[url]:not([reg]),[tip]").hover(
		function(e) {
			if($(this).attr('tip') != undefined){
				...
				$('body').append( '<p id="vtip"><img id="vtipArrow" src="/crm/script/easyvalidator/images/vtip_arrow.png"/>' + $(this).attr('tip') + '</p>' );
...
function showhover(obj) {
	if ($(obj).attr('tip') != undefined) {
		...
		$('body').append('<p id="vtip"><img id="vtipArrow" src="/crm/script/easyvalidator/images/vtip_arrow.png"/>' + $(obj).attr('tip') + '</p>');
		$('p#vtip').css("top", top + "px").css("left", left + "px");
		$('p#vtip').bgiframe();
	}
}
